...
public enum SyncOptionTypes {
	...
	DoNotDropColumns,    // Column will not be deleted in Cassandra
	DoNotAddIndexes,     // Indexes will not be added in Cassandra
	DoNotDropIndexes     // Indexes will not be deleted in Cassandra
}