...
//	private static final Logger log = Logger.getLogger(EntityMetadataParser.class.getName());
	...
	/**
	 * Retrieves class level annotations and initializes EntityMetadata object for given entity class
	 * @param clazz
			...
			if (f.getAnnotation(Transient.class) == null && javaTypeToDataType.get(f.getType()) != null) {
				...
				for (Method m: methods) {
					...
					if (setter!=null && getter != null) {
						...
						EntityTypeMetadata.FieldData fd = new EntityTypeMetadata.FieldData(f, dataType, getter, setter, columnName, isIdField);
